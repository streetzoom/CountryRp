...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["duty"] = {
        ...
        [2] = vector3(-256.09, 6327.49, 32.43), -- paleto
    },
    ["vehicle"] = {
        [1] = vector4(294.578, -574.761, 43.179, 35.79),
        [2] = vector4(-267.4, 6333.14, 32.43, 311.09), -- paleto
    },
    ["helicopter"] = {
        [1] = vector4(351.58, -587.45, 74.16, 160.5),
        [2] = vector4(-394.25, 6666.53, 7.68, 263.52), -- paleto
    },
    ["armory"] = {
        [1] = vector3(309.93, -602.94, 43.29),
        [2] = vector3(-254.84, 6326.44, 32.43), -- paleto
    },
    ["roof"] = {
    ...
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(-249.44, 6324.06, 32.43, 122.27)} -- paleto
    }
}
