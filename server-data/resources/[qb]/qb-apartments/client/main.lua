...
RegisterNetEvent('apartments:client:SetHomeBlip', function(home)
    CreateThread(function()
        ...
        for name, _ in pairs(Apartments.Locations) do
            ...
            if (name == home) then
                SetBlipSprite(Apartments.Locations[name].blip, 40) -- House icon
                SetBlipColour(Apartments.Locations[name].blip, 2) -- Set icon color to green
            else
                SetBlipSprite(Apartments.Locations[name].blip, 40) -- House icon
                SetBlipColour(Apartments.Locations[name].blip, 1) -- Set icon color to red
            end
