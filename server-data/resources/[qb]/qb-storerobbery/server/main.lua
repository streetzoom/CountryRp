...
CreateThread(function()
    while true do
        SafeCodes = {
            [1] = 1, -- math.random(1000, 9999),
            [2] = 1, -- {math.random(1, 149), math.random(500.0, 600.0), math.random(360.0, 400), math.random(600.0, 900.0)},
            [3] = 1, -- {math.random(150, 359), math.random(-300.0, -60.0), math.random(0, 100), math.random(-500.0, -160.0)},
            [4] = 1, -- math.random(1000, 9999),
            [5] = 1, -- math.random(1000, 9999),
            [6] = 1, -- {math.random(1, 149), math.random(150.0, 200.0), math.random(100, 140), math.random(150.0, 220.0), math.random(-100, 100), math.random(140, 300)},
            [7] = 1, -- math.random(1000, 9999),
            [8] = 1, -- math.random(1000, 9999),
            [9] = 1, -- math.random(1000, 9999),
            [10] = 1, -- {math.random(1, 149), math.random(300.0, 500.0), math.random(200, 260), math.random(500.0, 800.0), math.random(300, 440), math.random(650, 900)},
            [11] = 1, -- math.random(1000, 9999),
            [12] = 1, -- math.random(1000, 9999),
            [13] = 1, -- math.random(1000, 9999),
            [14] = 1, -- {math.random(150, 450), math.random(-360.0, 0.0), math.random(360, 720)},
            [15] = 1, -- math.random(1000, 9999),
            [16] = 1, -- math.random(1000, 9999),
            [17] = 1, -- math.random(1000, 9999),
            [18] = 1, -- {math.random(150, 450), math.random(1.0, 100.0), math.random(360, 450), math.random(300.0, 340.0), math.random(350, 400), math.random(320.0, 340.0), math.random(350, 600)},
            [19] = 1, -- math.random(1000, 9999),
        }
        Wait((1000 * 60) * 40)
    end
end)
