...
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector3(1693.32, 4823.48, 41.06), width = 2, length = 2}, -- Grapeseed
    [2] = {shopType = 'clothing', coords = vector3(4.254, 6512.813, 30.877), width = 2, length = 2}, -- Paleto
    [3] = {shopType = 'clothing', coords = vector3(615.180, 2762.933, 41.088), width = 2, length = 2}, -- Grand Senora
    [4] = {shopType = 'clothing', coords = vector3(1196.785, 2709.558, 37.222), width = 2, length = 2}, -- Grand Senora
    [5] = {shopType = 'barber', coords = vector3(1931.5, 3729.7, 31.8), width = 2, length = 2}, -- Sandy
    [6] = {shopType = 'barber', coords = vector3(-278.1, 6228.5, 30.7), width = 2, length = 2} -- Paleto
}
