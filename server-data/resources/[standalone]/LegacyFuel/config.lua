...
-- Gas stations locations, also used as coords for blips.
Config.GasStations = {
	-- Sandy area gas stations.
	vector3(2005.055, 3773.887, 32.403), -- SandyShoresGasStations 1
	vector3(1717.7, 3602.55, 35.17),     -- SandyFireStation

	-- GrapeSeed area gas stations.
	vector3(1687.156, 4929.392, 42.078), -- GrapeSeedGasStations 1

	-- Paleto area gas stations.
	vector3(1701.314, 6416.028, 32.763), -- PaletoHighwayGasStation 1
	vector3(179.857, 6602.839, 31.868),  -- PaletoMainGasStation 2
	vector3(-94.4619, 6419.594, 31.489), -- PaletoGasStation 1
	vector3(155.52, 6630.31, 31.81), 	 -- PaletoMainGasStation 1
	vector3(127.74, 6416.11, 31.33),     -- PaletoParking
	vector3(-286.47, 6139.48, 31.5)   	 -- PaletoBusStop

	-- Gas stations below are temporarily disabled due to unused.
